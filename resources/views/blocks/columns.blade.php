...
@elseif ($columns_type === '1/2')
    <div class="column grid sm:grid-cols-12 items-center gap-6 min-h-[600px]">
        ...
        <div class="hidden md:block md:col-span-1"></div>
        <div class="column-image col-span-6 h-[350px] sm:h-full relative">
...
@elseif ($columns_type === '1/2-reverse')
    <div class="column grid sm:grid-cols-12 items-center gap-6 min-h-[600px]">
        <div class="column-image col-span-6 order-2 h-[350px] sm:h-full relative">
            <div class="w-full h-full  absolute top-0 left-0">
                @if ($image)
                    <x-image :src="$image['url']" :alt="$image['alt']" />
                @endif
        ...
        <div class="column-content order-1 col-span-5">
            <InnerBlocks />
        </div>
    </div>
@else
